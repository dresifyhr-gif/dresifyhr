        ...
        <>
          ...
          >
            <div className="mb-6 flex items-center justify-between">
              <div>
                <p className="text-xs uppercase tracking-[0.35em] text-white/45">Košarica</p>
            ...
            <div className="flex-1 space-y-3 overflow-y-auto pr-1">
              {items.length ? (
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="min-w-0 flex-1">
                        ...
                        <div className="mt-3 flex items-center justify-between gap-3 text-sm">
                          <span className="text-white/55">Veličina: {item.size}</span>
                ...
                <div className="border border-dashed border-white/10 bg-[#111111] p-8 text-center text-sm leading-7 text-white/50">
                  Košarica je prazna. Odaberi dres, veličinu i dodaj ga u košaricu.
                </div>
              )}
            </div>
            ...
            <div className="mt-6 border border-white/10 bg-[#111111] p-5">
              <div className="space-y-3 text-sm text-white">
                <div className="flex items-center justify-between">
                  <span className="font-medium uppercase tracking-[0.2em] text-white/50">Artikli</span>
                  <span className="font-semibold">{formatEuroAmount(subtotal)}</span>
                </div>
                <div className="flex items-center justify-between">
                  <span className="font-medium uppercase tracking-[0.2em] text-white/50">Dostava</span>
                  <span className="font-semibold">{items.length ? SHIPPING_PRICE_LABEL : ZAGREB_DELIVERY_PRICE_LABEL}</span>
                </div>
                <div className="flex items-center justify-between border-t border-white/10 pt-3">
                  <span className="font-medium uppercase tracking-[0.28em] text-white/50">Ukupno</span>
