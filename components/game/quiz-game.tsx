    ...
    return (
      <Frame footer={<p className="text-[12px] text-white/55">Treba {NEEDED}/{TOTAL_Q} točnih ⚡</p>}>
        <div className="flex flex-col items-center gap-4 py-6 text-center">
          ...
          <p className="max-w-[270px] text-[13px] text-white/70">Odgovori svih {NEEDED} točno i biraš nagradu: <b className="text-accent">poklon iznenađenja</b> ili <b className="text-accent">10% popusta</b> (od 20€).</p>
