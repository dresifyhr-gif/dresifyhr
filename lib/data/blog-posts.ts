...
export const blogPosts: BlogPost[] = [
  ...
  ,{
    ...
    paragraphs: [
      ...
      "Za dostavu unutar Zagreba nudimo besplatnu osobnu dostavu bez dodatnog troška. Za ostatak Hrvatske dostava iznosi 7,50 € i uključuje HP Paket24 uslugu s pouzećem. Rok isporuke je 1 do 3 radna dana od potvrde narudžbe, a pratimo svaki paket do preuzimanja. Ako naručujete za posebnu prigodu — rođendan, poklon, natjecanje — javite nam rok i pokušat ćemo ga ispoštovati. U većini slučajeva to nije problem ako narudžba stigne dovoljno rano.",
