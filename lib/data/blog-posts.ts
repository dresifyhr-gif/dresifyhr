...
export const blogPosts: BlogPost[] = [
  ...
  ,{
    ...
    paragraphs: [
      ...
      "Dostava ide po cijeloj Hrvatskoj i iznosi 7,50 € uz HP Paket24 uslugu s plaćanjem pouzećem. Rok isporuke je 2 do 5 radnih dana od potvrde narudžbe, a pratimo svaki paket do preuzimanja. Ako naručujete za posebnu prigodu — rođendan, poklon, natjecanje — javite nam rok i pokušat ćemo ga ispoštovati. U većini slučajeva to nije problem ako narudžba stigne dovoljno rano.",
